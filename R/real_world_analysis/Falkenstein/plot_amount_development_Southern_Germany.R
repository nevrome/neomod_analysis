...
spu %>%
  ggsave(
    "/home/clemens/neomod/neomod_analysis/R/real_world_analysis/Falkenstein/plot_amount_burial_type.jpeg",
    #"/home/clemens/neomod/neomod_analysis/R/real_world_analysis/Falkenstein/plot_amount_burial_construction.jpeg",
    plot = .,
    device = "jpeg",
    scale = 1,
    dpi = 300,
