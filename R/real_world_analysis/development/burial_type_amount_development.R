load("../neomod_datapool/R_data/development_amount_burial_type.RData")
...
spu %>%
  ggsave(
    "/home/clemens/neomod/neomod_datapool/plots/development/development_amount_regions_burial_type.jpeg",
    plot = .,
    device = "jpeg",
    scale = 1,
    dpi = 300,
